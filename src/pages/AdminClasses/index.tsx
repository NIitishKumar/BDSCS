...
import { Plus, Search, Edit, Trash2, Users, BookOpen, User, Phone, Mail, Calendar, ArrowLeft, Filter, Download, Upload, Check, X, Save, UserPlus, School, Clock, MapPin, GraduationCap, PlayCircle, CheckCircle, XCircle, FileText, UserCheck, AlertCircle, Settings, BarChart3, Shield, Bell, Database, Activity, Award, TrendingUp, Eye, RefreshCw } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'lectures' | 'teachers' | 'classes' | 'students' | 'reports'>('dashboard');
  const [showCreateLectureForm, setShowCreateLectureForm] = useState<boolean>(false);
  const [showAssignLectureForm, setShowAssignLectureForm] = useState<boolean>(false);
  ...
  const subjects = ['Mathematics', 'Science', 'English', 'Social Studies', 'Hindi', 'Computer Science', 'Physical Education', 'Arts', 'Music'];
  const daysOfWeek = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];

  const handleCreateLecture = () => {
    if (newLecture.title && newLecture.classId && newLecture.teacherId && newLecture.date) {
      const selectedClass = classes.find(c => c.id === newLecture.classId);
      const selectedTeacher = teachers.find(t => t.id === newLecture.teacherId);
  ...
  const handleBulkAssignment = () => {
    if (bulkAssignment.teacherId && bulkAssignment.classId && bulkAssignment.startDate && bulkAssignment.endDate) {
      const selectedClass = classes.find(c => c.id === bulkAssignment.classId);
      const selectedTeacher = teachers.find(t => t.id === bulkAssignment.teacherId);
  ...
  const handleAddTeacher = () => {
    if (newTeacher.name && newTeacher.email && newTeacher.subject && newTeacher.employeeId) {
  ...
  const getClassStats = () => {
    return {
      ...
      enrollmentRate: Math.round((students.length / classes.reduce((sum, cls) => sum + cls.capacity, 0)) * 100)
    };
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeTab === 'dashboard' && (
          <>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{getTeacherStats().totalTeachers}</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{getClassStats().totalStudents}</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-purple-500 to-violet-600 rounded-2xl p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{getClassStats().totalClasses}</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-pink-500 to-rose-600 rounded-2xl p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{getTeacherStats().scheduledLectures}</p>
                  </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 ml-4">Create Lecture</h3>
                </div>
                <p className="text-gray-600">Schedule a new lecture and assign it to a teacher</p>
              </div>
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 ml-4">Bulk Assignment</h3>
                </div>
                <p className="text-gray-600">Assign multiple lectures to teachers at once</p>
              </div>
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 ml-4">Add Teacher</h3>
                </div>
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Recent Lecture Assignments</h3>
                  ...
                  <div key={lecture.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{lecture.className} • {lecture.teacherName}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-sm text-gray-600">{new Date(lecture.date).toLocaleDateString()}</p>
          ...
          <>
            ...
            <div className="space-y-4">
              {getFilteredLectures().map((lecture) => (
                <div key={lecture.id} className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-3">
                        <h3 className="text-xl font-bold text-gray-900 mr-4">{lecture.title}</h3>
                        <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(lecture.status)}`}>
                      ...
                      <div className="text-xs text-gray-500">
                        Assigned by {lecture.assignedBy} on {new Date(lecture.assignedAt).toLocaleDateString()}
                      </div>
                    </div>
              ...
              {getFilteredLectures().length === 0 && (
                <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg p-12 text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-500 mb-2">No Lectures Found</h3>
          ...
          <>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {teachers.map((teacher) => (
                <div key={teacher.id} className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg p-6">
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <div className="flex justify-between text-sm mt-2">
                      ...
                      <span className="font-semibold">{lectures.filter(l => l.teacherId === teacher.id).length}</span>
                    </div>
                  </div>
        ...
        {activeTab === 'classes' && (
          <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Classes Overview</h2>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {classes.map((cls, index) => (
                    <tr key={cls.id} className={`border-b border-gray-100 hover:bg-gray-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                      ...
                      <td className="px-6 py-4 text-gray-700">{cls.capacity}</td>
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-green-500 to-emerald-600 text-white">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left font-semibold">Parent Phone</th>
                    <th className="px-6 py-4 text-left font-semibold">Status</th>
                  </tr>
                </thead>
                <tbody>
                  {students.map((student, index) => (
                    <tr key={student.id} className={`border-b border-gray-100 hover:bg-green-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                      <td className="px-6 py-4">
                        <div className="flex items-center">
        ...
        {activeTab === 'reports' && (
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">System Statistics</h3>
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-gray-900">{lectures.length}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Enrollment Rate</span>
                  <span className="font-bold text-gray-900">{getClassStats().enrollmentRate}%</span>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewLecture({...newLecture, classId: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setBulkAssignment({...bulkAssignment, classId: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                  >
                    <option value="">Select Class</option>
                    {classes.map(cls => (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setBulkAssignment({...bulkAssignment, startDate: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setBulkAssignment({...bulkAssignment, endDate: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setBulkAssignment({...bulkAssignment, startTime: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setBulkAssignment({...bulkAssignment, endTime: e.target.value})}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
              </div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            ...
                            setBulkAssignment({
                              ...bulkAssignment,
                              daysOfWeek: bulkAssignment.daysOfWeek.filter(d => d !== day)
                            });
                          }
                        }}
